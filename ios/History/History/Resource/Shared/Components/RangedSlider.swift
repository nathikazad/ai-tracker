    ...
    @ViewBuilder private func sliderView(sliderSize: CGSize) -> some View {
        ...
        ZStack {
            ...
            ZStack {
                ...
                let rightThumbLocation = CGFloat(currentValue.wrappedValue.upperBound) * stepWidthInPixel + stepWidthInPixel
                ...
                thumbView(position: leftThumbPoint, value: currentValue.wrappedValue.lowerBound)
                    .highPriorityGesture(DragGesture().onChanged { dragValue in
                        ...
                        let newValue = Int(Double(sliderBounds.lowerBound) + Double(xThumbOffset / stepWidthInPixel).rounded())
