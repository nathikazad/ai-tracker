...
int hm01b0_init(const struct hm01b0_config* config)
{
    ...
    printf("hm01b0_init: resolution set\n");
    ...
    printf("hm01b0_init: data bits set\n");
    ...
    printf("hm01b0_init: reset pin set\n");
    ...
    printf("hm01b0_init: mclk pin set\n");
    ...
    printf("hm01b0_init: i2c set\n");

    uint16_t model_id = hm01b0_read_reg16(0x0000);
    printf("hm01b0_init: model id = 0x%04x\n", model_id);
    if (model_id != 0x01b0) {
