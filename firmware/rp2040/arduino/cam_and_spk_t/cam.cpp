...
// static SLIC slic;
uint8_t pixels[IMAGE_BUFFER_SIZE];
// uint8_t compressedBuffer[IMAGE_BUFFER_SIZE];
...
void sendImage() {
  ...
  //                             compressedBuffer, IMAGE_BUFFER_SIZE);
  ...
  //   rc = slic.encode(pixels, IMAGE_BUFFER_SIZE);
  ...
  uint32_t pixelSize = IMAGE_BUFFER_SIZE;
