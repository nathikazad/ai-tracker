...
app.post('/convertMessageToEvent', async (req, res) => {
    ...
    let prompt = `You are in charge of converting user messages into a graphql mutations that will store (or modify) things a user does into a structured database for querying later. 
