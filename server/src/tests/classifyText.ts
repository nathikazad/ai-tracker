...
async function main() {
    ...
    check("I weigh 88 kilos", Classification.Unknown)
    check("I want to wake up at 5:30 everyday", Classification.Unknown)
    check("I want to drink protein shake every night at 8pm", Classification.Unknown)
    check("I want to call my mom every monday morning at 7pm", Classification.Unknown)
}
